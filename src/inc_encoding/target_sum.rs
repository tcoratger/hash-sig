...
/// TARGET_SUM_OFFSET determines how we set the target sum.
/// It is added to the expected sum.
pub struct TargetSumEncoding<MH : MessageHash, const CHUNK_SIZE: usize, const TARGET_SUM_OFFSET: usize> {
    _marker_mh: std::marker::PhantomData<MH>,
}

impl<MH : MessageHash, const CHUNK_SIZE: usize, const TARGET_SUM_OFFSET: usize>
TargetSumEncoding<MH, CHUNK_SIZE, TARGET_SUM_OFFSET> {
    ...
    const TARGET_SUM: usize = Self::EXPECTED_SUM + TARGET_SUM_OFFSET;
}

impl<MH : MessageHash, const CHUNK_SIZE: usize, const TARGET_SUM_OFFSET: usize> IncomparableEncoding for TargetSumEncoding<MH, CHUNK_SIZE, TARGET_SUM_OFFSET> {
